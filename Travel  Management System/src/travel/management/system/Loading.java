...
public class Loading extends JFrame implements Runnable {
	...
	public Loading(String username) {
            ...
            JLabel hii=new JLabel("Welcome "+username);
            hii.setBounds(50,250,120,70);
            hii.setForeground(Color.RED);
            hii.setFont(new Font("Raleway",Font.BOLD,16));
            contentPane.add(hii);
