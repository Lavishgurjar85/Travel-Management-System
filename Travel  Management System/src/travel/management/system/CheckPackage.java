...
public class CheckPackage extends JFrame{
    JButton lblCheckInStatus;
    String username;
    public static void main(String[] args) {
      new CheckPackage("").setVisible(true);
    }

    CheckPackage(String usernames) {    
      setBounds(375, 150, 900, 600);  
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","SILVER PACKAGE","6 days and 7 Nights", "Airport Assistance at Aiport", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Island Cruise", "English Speaking Guide", "BOOK NOW", "Summer Special", "Rs 12000 only"};
      String[] package2 = new String[]{"package2.jpg","GOLD PACKAGE","4 days and 3 Nights", "Toll Free and Entrance Free Tickets", "Meet and Greet at Aiport", "Welcome drinks on Arrival", "Night Safari", "Full Day 3 Island Cruise", "Cruise with Dinner", "BOOK NOW", "Winter Special", "Rs 25000 only"};
      String[] package3 = new String[]{"package3.jpg","PLATINUM PACKAGE","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Winter Special", "Rs 32000 only"};
    ...
    public JPanel createPackage(String[] pack){
        ...
        p1.add(lblReserveRoomNumber);
         ...
         lblCheckInStatus = new JButton(pack[9]);
